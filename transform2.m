...
%         ri1(i,:) = script_roation( C2-C1,sph2cart(ri1(i,1),ri1(i,2),ri1(i,3))-C1, coefazimuth(mtia1(i)), coefelevation1(mtit1(i))) + C1;
%         ri2(i,:) = script_roation( C2-C1,sph2cart(ri2(i,1),ri2(i,2),ri2(i,3))-C1, coefazimuth(mtia2(i)), coefelevation1(mtit2(i))) + C1;
%         ri3(i,:) = script_roation( C2-C1,sph2cart(ri3(i,1),ri3(i,2),ri3(i,3))-C1, coefazimuth(mtia3(i)), coefelevation1(mtit3(i))) + C1;
%         ri4(i,:) = script_roation( C2-C1,sph2cart(ri4(i,1),ri4(i,2),ri4(i,3))-C1, coefazimuth(mtia4(i)), coefelevation1(mtit4(i))) + C1;
        ri1(i,:) = script_roation( C2-C1,sph2cart(ri1(i,1),ri1(i,2),ri1(i,3))-C1, coefazimuth(mtia1(i)), coefelevation1(mtit1(i))) + C1;
        ri2(i,:) = script_roation( C2-C1,sph2cart(ri2(i,1),ri2(i,2),ri2(i,3))-C1, coefazimuth(mtia2(i)), coefelevation1(mtit2(i))) + C1;
        ri3(i,:) = script_roation( C2-C1,C3-C1, coefazimuth(mtia3(i)), coefelevation1(mtit3(i))) + C1;
        ri4(i,:) = script_roation( C2-C1,C4-C1, coefazimuth(mtia4(i)), coefelevation1(mtit4(i))) + C1;
    end
